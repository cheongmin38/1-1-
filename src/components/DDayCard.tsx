...
import { Timer, Star, PartyPopper, Plus, Trash2, X, Check } from 'lucide-react';
      ...
      <div className="space-y-1.5 flex-1 overflow-y-auto max-h-[300px] pr-1 scrollbar-hide">
        {isLoading ? (
          ...
          upcomingDays.map((d, i) => (
            <div key={d.id || i} className="group flex items-center justify-between p-4 bg-ios-bg/40 rounded-2xl border border-transparent hover:border-black/[0.03] transition-all">
              ...
              <div className="flex items-center gap-3">
                {isTeacher && (
                  <button 
                    ...
                    className="p-2 opacity-0 group-hover:opacity-100 text-ios-red/30 hover:text-ios-red transition-all"
                  >
