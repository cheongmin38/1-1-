...
export default function PlanCalendar() {
  ...
  useEffect(() => {
    ...
    const preEvents: Partial<Event>[] = [
      ...
      { title: '어린이날 (공휴일)', type: 'holiday', date: '2026-05-05' },
      { title: '스승의 날', type: 'activity', date: '2026-05-15' },
      { title: '평고 학급 체육대회', type: 'activity', date: '2026-05-18' },
      { title: '현장체험학습', type: 'activity', date: '2026-05-22' },
      { title: '현충일 (공휴일)', type: 'holiday', date: '2026-06-06' },
      ...
      { title: '여름방학 기간', type: 'holiday', date: '2026-07-20' },
      { title: '제81주년 광복절', type: 'holiday', date: '2026-08-15' },
      { title: '2학기 개학식', type: 'holiday', date: '2026-08-17' },
      { title: '추석 연휴', type: 'holiday', date: '2026-09-24' },
      { title: '추석 (공휴일)', type: 'holiday', date: '2026-09-25' },
      { title: '추석 연휴', type: 'holiday', date: '2026-09-26' },
      { title: '개천절 (공휴일)', type: 'holiday', date: '2026-10-03' },
      { title: '한글날 (공휴일)', type: 'holiday', date: '2026-10-09' },
      { title: '2학기 1차 지필평가 (중간)', type: 'exam', date: '2026-10-12' },
      { title: '2학기 1차 지필평가 (중간)', type: 'exam', date: '2026-10-13' },
      { title: '2학기 1차 지필평가 (중간)', type: 'exam', date: '2026-10-14' },
      { title: '대학수능시험일 (휴교)', type: 'holiday', date: '2026-11-19' },
      { title: '2학기 2차 지필평가 (기말)', type: 'exam', date: '2026-12-14' },
      { title: '2학기 2차 지필평가 (기말)', type: 'exam', date: '2026-12-15' },
      { title: '2학기 2차 지필평가 (기말)', type: 'exam', date: '2026-12-16' },
      { title: '성탄절 (공휴일)', type: 'holiday', date: '2026-12-25' },
      { title: '학년말 방학식', type: 'holiday', date: '2026-12-30' },
    ];
